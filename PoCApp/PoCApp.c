  ...
  )
{
  ...
  Print(L"Found %d handles with MyProtocol\n", HandleCount);
    ...
    if (MyProtocol != NULL && MyProtocol->sub_6651498 != NULL) {
        ...
        //MyProtocol->sub_6651498(0x4141414141414141, 0x4242424242424242, (__int64)my_bmp, 0x4444444444444444, 0x4545454545454545, 0x4646464646464646, 0x4747474747474747, 0x4848484848484848, 0x4949494949494949, 0x5050505050505050, 0x5151515151515151, 0x5252525252525252, 0x5353535353535353);
        MyProtocol->sub_6651498(0, 0, (__int64)my_bmp, 0, 0x4444444444444444, 0, 0, 0, 0, 0, 0, 0, 0);
